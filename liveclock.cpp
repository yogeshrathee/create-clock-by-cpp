...
int main()
{
    ...
    // Hour Hand
         setcolor(RED);
         line(250,250,250+100*sin(ltm->tm_hour * PI/6),250-150*cos(ltm->tm_hour * PI/6));
    // Minute Hand
         setcolor(GREEN);
         line(250,250,250+180*sin(ltm->tm_min * PI/30),250-190*cos(ltm->tm_min * PI/30));
    // Secod Hand
         setcolor(BROWN);
         line(250,250,250+140*sin(ltm->tm_sec * PI/30),250-150*cos(ltm->tm_sec * PI/30));
